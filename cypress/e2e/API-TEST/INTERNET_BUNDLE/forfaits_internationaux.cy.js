...
describe('FORFAITS_INTERNATIONAUX API Tests', () => {
    ...
    const randomId = 'FORFAITS-ID-' + Date.now();

    const requestBodyforSelf = {
        "request-id": randomId,
        "command-id": "BILL",
        "sender": "2250102919300",
        "destination": "FORFAITS_INTERNATIONAUX",
        "auth": "2222",
        "amount": "142",
        "remarks": "",
        "extended-data": {
    ...
    const responseSchema = {
        title: 'FORFAITS INTERNATIONAUX Response Schema',
        type: 'object',
    ...
    context('Successful FORFAITS INTERNATIONAUX', () => {
        it('should process FORFAITS INTERNATIONAUX for self and return success response', () => {
            cy.request({
                method: 'POST',
                url: validEndpoint,
        ...
        it('should process FORFAITS INTERNATIONAUX for others and return success response', () => {
            cy.request({
                method: 'POST',
                url: validEndpoint,
