...
describe('COMPTE MOOV ILLIMITE API Tests', () => {
    ...
    const randomId = 'ILLIMITE-ID-' + Date.now();

    const requestBodyforSelf = {
        "request-id": randomId,
        "command-id": "BILL",
        "sender": "2250102919300",
        "destination": "COMPTE_MOOV_ILLIMITE",
        "auth": "2222",
        "amount": "100",
        "remarks": "Moov Illimite Request",
        "extended-data": {
    ...
    const requestBodyforOthers = {
        ...
        "auth": "2222",
        "amount": "100",
        "remarks": "Moov Illimite To Others Request",
        "extended-data": {
            "custommessage": "",
            "account-number": "",
            "cellid": "0",
            ...
            "ext2": "2250142373758",
            "ext1": "3039",
            "refillprofileid": "3039"
        }
    };

    // Validate response structure
    const responseSchema = {
        title: 'COMPTE MOOV ILLIMITE Response Schema',
        type: 'object',
    ...
    context('Successful COMPTE MOOV ILLIMITE', () => {
        it('should process COMPTE MOOV ILLIMITE for self and return success response', () => {
            cy.request({
                method: 'POST',
                url: validEndpoint,
        ...
        it('should process COMPTE MOOV ILLIMITE for others and return success response', () => {
            cy.request({
                method: 'POST',
                url: validEndpoint,
