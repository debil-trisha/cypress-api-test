...
describe('COMPTE BUNDLE ROAMING API Tests', () => {
    ...
    const randomId = 'ROAMING-ID-' + Date.now();

    const requestBodyforSelf = {
        "request-id": randomId,
        "command-id": "BILL",
        "sender": "2250102919300",
        "destination": "COMPTE_BUNDLE_ROAMING",
        "auth": "2222",
        "amount": "2",
        "remarks": "DATA ROAMING REQUEST",
        "extended-data": {
            "custommessage": "",
            ...
            "biller-code": "COMPTE_BUNDLE_ROAMING",
            "lang": "F",
            "ext4": "MoovMoney",
            "ext2": "SELF",
            "ext1": "3900",
            "refillprofileid": "3900"
        }
    };
    ...
    const requestBodyforOthers = {
        ...
        "auth": "2222",
        "amount": "100",
        "remarks": "ROAMING OFFER TRANSACTION",
        "extended-data": {
            "custommessage": "",
            "account-number": "",
            "cellid": "0",
            ...
            "ext2": "2250142373758",
            "ext1": "6164",
            "refillprofileid": "6164"
        }
    };

    // Validate response structure
    const responseSchema = {
        title: 'COMPTE BUNDLE ROAMING Response Schema',
        type: 'object',
    ...
    context('Successful COMPTE BUNDLE ROAMING', () => {
        it('should process COMPTE BUNDLE ROAMING for self and return success response', () => {
            cy.request({
                method: 'POST',
                url: validEndpoint,
        ...
        it('should process COMPTE BUNDLE ROAMING for others and return success response', () => {
            cy.request({
                method: 'POST',
                url: validEndpoint,
