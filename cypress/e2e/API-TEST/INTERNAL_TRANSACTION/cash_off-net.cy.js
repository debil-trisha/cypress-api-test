...
describe('OFF NET Cash Transfer API Tests', () => {
    ...
    const randomId = 'OffnetID-' + Date.now();
    ...
    context('Successful OFF NET Cash Transfer', () => {
        it('should process off net cash transfer and return success response', () => {
            cy.request({
                method: 'POST',
                url: validEndpoint,
                body: requestBody,
